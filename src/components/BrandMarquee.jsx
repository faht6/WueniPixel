...
import { Apple, Smartphone, ShieldCheck, Truck, CreditCard } from 'lucide-react';

const BrandMarquee = () => {
    const brands = [
        { name: "Apple", icon: <Apple size={24} /> },
        { name: "Google Pixel", icon: <Smartphone size={24} /> },
        { name: "Garantía", icon: <ShieldCheck size={24} /> },
        { name: "Envío Gratis", icon: <Truck size={24} /> },
        { name: "Medios de Pago", icon: <CreditCard size={24} /> },
        { name: "Apple", icon: <Apple size={24} /> },
        { name: "Google Pixel", icon: <Smartphone size={24} /> },
        { name: "Garantía", icon: <ShieldCheck size={24} /> },
        { name: "Envío Gratis", icon: <Truck size={24} /> },
